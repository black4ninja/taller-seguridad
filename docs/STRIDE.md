# Mapeo STRIDE → Control NIST 800-53 → Commit

**Entregable paralelo.** Llena esta tabla a medida que resuelves cada vulnerabilidad.
Sirve para que fijes el ciclo teórico que vieron en clase: test falla → STRIDE identifica la categoría → NIST 800-53 te dice qué control implementar → tu commit lo aplica.

## Tabla a llenar

| # | Test archivo | Letra STRIDE | Amenaza concreta | Control NIST 800-53 | Archivo(s) modificado(s) | Hash del commit |
|---|---|---|---|---|---|---|
...
| **SI** | System & Information Integrity | Validación de input, sanitización (V2, V4) |
